...
See the [getting started guide](/getting-started/) or the [GitHub repository](https://github.com/openinfer-project/openinfer).
...
- **[OpenInfer 0.1.0: Production-Grade Rust Inference](/blog/openinfer-010/)** (2026-06-13) — Architecture, footprint, cold-start, and RTX 5090 serving benchmarks.
...
![Process RSS: openinfer vs vLLM](/blog/openinfer-010/rss.png)
...
![Cold start: openinfer vs vLLM](/blog/openinfer-010/startup.png)
...
![Serving sweep vs vLLM on RTX 5090](/blog/openinfer-010/qps.png)
...
![Warm prefix-cache-hit TTFT sweep](/blog/openinfer-010/warm_ttft.png)
